...
const Button: FC<Props> = ({
  ...
  switch (variant) {
    ...
    case "outline":
      baseClassName =
        "bg-white border border-gray-300 shadow-sm text-sm  text-gray-700 hover:bg-gray-50 dark:bg-dark-bg-700 dark:hover:bg-dark-bg-900  border-opacity-20 dark:text-white"
      break
    default:
      baseClassName =
        "border border-opacity-20 border-transparent shadow-sm text-sm  text-white bg-primary-400 hover:bg-primary-500"
  }
