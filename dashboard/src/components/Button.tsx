...
const Button: FC<Props> = ({
  ...
  switch (variant) {
    ...
    case "outline":
      baseClassName =
        "bg-white border border-gray-300 shadow-sm text-gray-700 hover:bg-gray-50 dark:bg-dark-bg-700 dark:hover:bg-dark-bg-900  border-opacity-20 dark:text-white"
      break
    default:
      baseClassName =
